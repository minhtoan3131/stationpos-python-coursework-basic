...
"    QLabel.kpi-label { font-size: 13px; font-weight: 600; color: #64748b; text-transform: uppercase; }\n"
...
"   ")
        ...
        self.tbl_monthly_tax.setMinimumHeight(450)
        ...
        self.spn_threshold.setGroupSeparatorShown(True)
